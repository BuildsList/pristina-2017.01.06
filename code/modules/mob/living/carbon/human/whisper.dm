...
/mob/living/carbon/human/proc/whisper_say(var/message, var/datum/language/speaking = null, var/alt_name="", var/verb="whispers")
	...
	if(voice_sub == "Unknown")
		if(copytext(message, 1, 2) != "*")
			...
			message = replacetextSS(message, "o", "¤")
			message = replacetextSS(message, "p", "þ")
			message = replacetextSS(message, "l", "£")
			message = replacetextSS(message, "s", "§")
			message = replacetextSS(message, "u", "µ")
			message = replacetextSS(message, "b", "ß")
