...
//	t = copytext(sanitize(t),1,MAX_MESSAGE_LEN)
	...
	t = replacetextSS(t, "\[center\]", "<center>")
	t = replacetextSS(t, "\[/center\]", "</center>")
	t = replacetextSS(t, "\[br\]", "<BR>")
	t = replacetextSS(t, "\[b\]", "<B>")
	t = replacetextSS(t, "\[/b\]", "</B>")
	t = replacetextSS(t, "\[i\]", "<I>")
	t = replacetextSS(t, "\[/i\]", "</I>")
	t = replacetextSS(t, "\[u\]", "<U>")
	t = replacetextSS(t, "\[/u\]", "</U>")
	t = replacetextSS(t, "\[time\]", "[worldtime2text()]")
	t = replacetextSS(t, "\[date\]", "[worlddate2text()]")
	t = replacetextSS(t, "\[large\]", "<font size=\"4\">")
	t = replacetextSS(t, "\[/large\]", "</font>")
	t = replacetextSS(t, "\[sign\]", "<font face=\"[signfont]\"><i>[get_signature(P, user)]</i></font>")
	t = replacetextSS(t, "\[field\]", "<span class=\"paper_field\"></span>")

	t = replacetextSS(t, "\[h1\]", "<H1>")
	t = replacetextSS(t, "\[/h1\]", "</H1>")
	t = replacetextSS(t, "\[h2\]", "<H2>")
	t = replacetextSS(t, "\[/h2\]", "</H2>")
	t = replacetextSS(t, "\[h3\]", "<H3>")
	t = replacetextSS(t, "\[/h3\]", "</H3>")

	if(!iscrayon)
		t = replacetextSS(t, "\[*\]", "<li>")
		t = replacetextSS(t, "\[hr\]", "<HR>")
		t = replacetextSS(t, "\[small\]", "<font size = \"1\">")
		t = replacetextSS(t, "\[/small\]", "</font>")
		t = replacetextSS(t, "\[list\]", "<ul>")
		t = replacetextSS(t, "\[/list\]", "</ul>")
		t = replacetextSS(t, "\[table\]", "<table border=1 cellspacing=0 cellpadding=3 style='border: 1px solid black;'>")
		t = replacetextSS(t, "\[/table\]", "</td></tr></table>")
		t = replacetextSS(t, "\[grid\]", "<table>")
		t = replacetextSS(t, "\[/grid\]", "</td></tr></table>")
		t = replacetextSS(t, "\[row\]", "</td><tr>")
		t = replacetextSS(t, "\[cell\]", "<td>")
		t = replacetextSS(t, "\[logo\]", "<img src = ntlogo.png>")

		t = "<font face=\"[deffont]\" color=[P ? P.colour : "black"]>[t]</font>"
	else // If it is a crayon, and he still tries to use these, make them empty!
		t = replacetextSS(t, "\[*\]", "")
		t = replacetextSS(t, "\[hr\]", "")
		t = replacetextSS(t, "\[small\]", "")
		t = replacetextSS(t, "\[/small\]", "")
		t = replacetextSS(t, "\[list\]", "")
		t = replacetextSS(t, "\[/list\]", "")
		t = replacetextSS(t, "\[table\]", "")
		t = replacetextSS(t, "\[/table\]", "")
		t = replacetextSS(t, "\[row\]", "")
		t = replacetextSS(t, "\[cell\]", "")
		t = replacetextSS(t, "\[logo\]", "")

		t = "<font face=\"[crayonfont]\" color=[P ? P.colour : "black"]><b>[t]</b></font>"

//	t = replacetextSS(t, "#", "") // Junk converted to nothing!
